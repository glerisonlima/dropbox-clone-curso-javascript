...
class DropboxController{
    ...
    connectFirebase(){
        var firebaseConfig = {
            apiKey: "AIzaSyCvd9bqsReNsMLVlHhdcpABIXPIJNAx3QE",
            authDomain: "dropbox-clone-52a44.firebaseapp.com",
            databaseURL: "https://dropbox-clone-52a44.firebaseio.com",
            projectId: "dropbox-clone-52a44",
            storageBucket: "",
            messagingSenderId: "345581145229",
            appId: "1:345581145229:web:3b4e7211c556caa7"
          };
          // Initialize Firebase
    ...
    uploadTask(files){
        ...
        [...files].forEach(file => {
            ...
            */
            // ----SALVAR ARQUIVO NO DISCO LOCAL DO SERVIDOR----
            let formData = new FormData()
    ...
    formatTimeToHuman(duration){
        ...
        if(hours) return `${hours} horas ${minutes} minutos e ${seconds} segundos`
        if(minutes) return `${minutes} minutos e ${seconds} segundos`
        if(seconds) return `${seconds} segundos`
        return ''
